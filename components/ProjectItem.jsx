...
const ProjectItem = ({ title, backgroundImg, projectUrl }) => {
  return (
    <div className="w-full h-[300px] sm:h-[400px]">
      <div className="relative flex justify-center items-center h-full w-full shadow-xl shadow-[#2e3944] rounded-xl p-4 group hover:bg-gradient-to-r from-[#124e66] to-[#748d92] flex-shrink-0">
        <Image
